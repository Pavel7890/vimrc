...
hi MatchParen guifg=#f6f3e8 ctermfg=7 guibg=#857b6f ctermbg=243 gui=none
...
hi NonText guifg=#808080 ctermfg=244 guibg=#131313 ctermbg=233 gui=none
hi LineNr guifg=#857b6f ctermfg=243 guibg=#131313 ctermbg=233 gui=none
hi StatusLine guifg=#f6f3e8 ctermfg=7 guibg=#444444 ctermbg=238 gui=none
...
hi Title guifg=#f6f3e8 ctermfg=7 guibg=NONE gui=none
hi Visual guifg=#f6f3e8 ctermfg=7 guibg=#444444 ctermbg=238 gui=none
hi SpecialKey guifg=#808080 ctermfg=244 guibg=#131313 ctermbg=236 gui=none
" Syntax highlighting
hi Comment guifg=#99968b ctermfg=246 gui=none
hi Todo guifg=#8f8f8f ctermfg=245 gui=none
hi Constant guifg=#e5786d ctermfg=173 gui=none
hi String guifg=#95e454 ctermfg=113 guibg=#131313 ctermbg=233 gui=none
...
hi yamlBaseKey guifg=#FFFFFF ctermfg=15 gui=underline,none
